---
name: triage
description: "Triage issues and external PRs through verified states."
...
Reach for this to move issues and external PRs through the triage state machine: categorise, verify, grill where needed, and write agent-ready briefs.
