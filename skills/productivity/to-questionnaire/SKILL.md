...
description: "Turn an open decision into a fillable questionnaire."
...
Reach for this when a decision cannot be fully answered here and someone else has to fill in the gaps. It turns the open decision into a questionnaire for them.
